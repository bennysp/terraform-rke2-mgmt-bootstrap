...
- `nodeDriver.checksum` is computed dynamically from `proxmox_node_driver_url` during Terraform plan/apply to avoid upstream chart checksum drift causing Rancher `hash does not match` errors.
